...
import key from "./assets/dashboard_integrations_key.png";
...
Our SDKs makes the process of generating a token a lot easier and is probably
...
<Image src={key} title="Generate a new private key" />

On this page, click the "Create a new key" button and a key will be generated
and downloaded with the key ID shown in the list. You will need to store these
securely as we will not show these to you again.
