...
```bash
curl -i -X GET "https://api.{subdomain}.gr4vy.com/payment-methods/77a76f7e-d2de-4bbc-ada9-d6a0015e6bd5" \
    -H "Authorization: Bearer [JWT_TOKEN]"
```
...
fetch(
  "https://api.{subdomain}.gr4vy.com/payment-methods/77a76f7e-d2de-4bbc-ada9-d6a0015e6bd5",
  {
    method: "GET",
    headers: {
      Authorization: "Bearer [JWT_TOKEN]",
...
```json title="GET /payment-methods/77a76f7e-d2de-4bbc-ada9-d6a0015e6bd5/authorize"
{
  ...
  "method": "paypal",
  "status": "created",
  "payment_method_status": "tokenized",
