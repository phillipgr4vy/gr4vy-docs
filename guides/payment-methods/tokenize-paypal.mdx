...
```bash
curl -i -X GET "https://api.{subdomain}.gr4vy.app/payment-methods/77a76f7e-d2de-4bbc-ada9-d6a0015e6bd5" \
    -H "Authorization: Bearer [JWT_TOKEN]"
```
...
fetch(
  "https://api.{subdomain}.gr4vy.app/payment-methods/77a76f7e-d2de-4bbc-ada9-d6a0015e6bd5",
  {
    method: "GET",
    headers: {
      Authorization: "Bearer [JWT_TOKEN]",
