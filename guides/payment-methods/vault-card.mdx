...
make it easy for a recurring customer to re-use a card they previously used in
your app. The card is automatcally vaulted and bound to the buyer ID or external
ID provided.
