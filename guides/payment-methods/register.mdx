...
In option 2, we don't have seperate APIs for different payment methods, instead
we have payment method definitions and use these to register distict payment
methods.
