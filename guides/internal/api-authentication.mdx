...
| `auth`              | A scope that represents all the acces needed by Gr4vy the cluster admin interface. This scope should only work for session-tokens generated by Gr4vy for a user. |
