...
```json title="POST /transactions"
{
  ...
  "payment_service_id": "paypal-169f5226-4644-4d1e-ac36-14999e73601f",
  "external_identifier": null,
  "created_at": "2013-07-16T19:23:00.000Z",
...
the `status` represents the new status of the transaction.
...
```bash
curl -i -X GET "https://api.{subdomain}.gr4vy.app/transactions/fe26475d-ec3e-4884-9553-f7356683f7f9" \
    -H "Authorization: Bearer [JWT_TOKEN]"
```
...
fetch(
  "https://api.{subdomain}.gr4vy.app/transactions/fe26475d-ec3e-4884-9553-f7356683f7f9",
  {
    method: "GET",
    headers: {
      Authorization: "Bearer [JWT_TOKEN]",
