...
```bash
curl -i -X GET "https://api.{merchant}.gr4vy.app/transactions/fe26475d-ec3e-4884-9553-f7356683f7f9" \
    -H "Authorization: Bearer [JWT_TOKEN]"
```
...
fetch(
  "https://api.{merchant}.gr4vy.app/transactions/fe26475d-ec3e-4884-9553-f7356683f7f9",
  {
    method: "GET",
    headers: {
      Authorization: "Bearer [JWT_TOKEN]",
