...
```bash {7}
curl -i -X POST "https://api.{gid}.gr4vy.app/transactions/fe26475d-ec3e-4884-9553-f7356683f7f9/capture \
    -H "Authorization: Bearer [JWT_TOKEN]"
```
...
fetch(
  "https://api.{gid}.gr4vy.app/transactions/fe26475d-ec3e-4884-9553-f7356683f7f9/capture",
  {
    method: "POST",
    headers: {
      Authorization: "Bearer [JWT_TOKEN]",
