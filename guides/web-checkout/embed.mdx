...
```html
<script src="https://cdn.{gid}.gr4vy.app/embed.latest.js"></script>
```
...
expect the ID of your Gr4vy instance (`gid`), the amount and currency of the
transaction, the country to process this transaction in, and the client token
