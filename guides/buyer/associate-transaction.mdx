...
The easiest way to associate a buyer to a transaction is to pass in a `buyer`
object with the `external_identifier` and an optional `display_name` value when
