...
```bash {5-6}
curl -i -X PUT "https://api.{merchant}.gr4vy.app/buyers/fe26475d-ec3e-4884-9553-f7356683f7f9" \
...
fetch(
  "https://api.{merchant}.gr4vy.app/buyers/fe26475d-ec3e-4884-9553-f7356683f7f9",
  {
    method: "PUT",
    headers: {
