...
The private key you created is part of a pair of keys, a key-pair! The private
key is held and only known to you. The public key is held by us and used to
validate that any API requests were made by the holder of the private key.
