...
Colors are named semantically, for example `primary` or `danger`. This allows us
...
Values can be a valid CSS property value. e.g. `colors.primary` could be a hex,
RGB or HSL. You can also have multiple shadows for a focus ring, e.g.
